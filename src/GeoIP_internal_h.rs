...
extern "C" {
    pub fn _GeoIP_seek_record_v6_gl(
        gi: *mut GeoIP,
        ipnum: geoipv6_t,
        gl: *mut GeoIPLookup,
    ) -> ::std::ffi::c_uint;
...
extern "C" {
    pub fn _GeoIP_addr_to_num_v6(addr: *const ::std::ffi::c_char) -> geoipv6_t;
}
extern "C" {
    pub fn _GeoIP_lookupaddress(host: *const ::std::ffi::c_char) -> ::std::ffi::c_ulong;
}
extern "C" {
    pub fn _GeoIP_lookupaddress_v6(host: *const ::std::ffi::c_char) -> geoipv6_t;
}
extern "C" {
    pub fn __GEOIP_V6_IS_NULL(v6: geoipv6_t) -> ::std::ffi::c_int;
}
extern "C" {
    pub fn _GeoIP_setup_dbfilename();
}
extern "C" {
    pub fn _GeoIP_full_path_to(file_name: *const ::std::ffi::c_char) -> *mut ::std::ffi::c_char;
}
extern "C" {
    pub fn _GeoIP_seek_record(gi: *mut GeoIP, ipnum: ::std::ffi::c_ulong) -> ::std::ffi::c_uint;
}
extern "C" {
    pub fn _GeoIP_seek_record_v6(gi: *mut GeoIP, ipnum: geoipv6_t) -> ::std::ffi::c_uint;
}
