...
pub const GEOIP_UNKNOWN_CONF: u32 = 127;
...
#[derive(Debug, Copy, Clone)]
pub struct GeoIPTag {
    pub GeoIPDatabase: *mut FILE,
    pub file_path: *mut ::std::ffi::c_char,
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of GeoIPTag"][::std::mem::size_of::<GeoIPTag>() - 112usize];
    ["Alignment of GeoIPTag"][::std::mem::align_of::<GeoIPTag>() - 8usize];
    ["Offset of field: GeoIPTag::GeoIPDatabase"]
        [::std::mem::offset_of!(GeoIPTag, GeoIPDatabase) - 0usize];
    ["Offset of field: GeoIPTag::file_path"][::std::mem::offset_of!(GeoIPTag, file_path) - 8usize];
    ["Offset of field: GeoIPTag::cache"][::std::mem::offset_of!(GeoIPTag, cache) - 16usize];
    ["Offset of field: GeoIPTag::index_cache"]
        [::std::mem::offset_of!(GeoIPTag, index_cache) - 24usize];
    ["Offset of field: GeoIPTag::databaseSegments"]
        [::std::mem::offset_of!(GeoIPTag, databaseSegments) - 32usize];
    ["Offset of field: GeoIPTag::databaseType"]
        [::std::mem::offset_of!(GeoIPTag, databaseType) - 40usize];
    ["Offset of field: GeoIPTag::mtime"][::std::mem::offset_of!(GeoIPTag, mtime) - 48usize];
    ["Offset of field: GeoIPTag::flags"][::std::mem::offset_of!(GeoIPTag, flags) - 56usize];
    ["Offset of field: GeoIPTag::size"][::std::mem::offset_of!(GeoIPTag, size) - 64usize];
    ["Offset of field: GeoIPTag::record_length"]
        [::std::mem::offset_of!(GeoIPTag, record_length) - 72usize];
    ["Offset of field: GeoIPTag::charset"][::std::mem::offset_of!(GeoIPTag, charset) - 76usize];
    ["Offset of field: GeoIPTag::record_iter"]
        [::std::mem::offset_of!(GeoIPTag, record_iter) - 80usize];
    ["Offset of field: GeoIPTag::netmask"][::std::mem::offset_of!(GeoIPTag, netmask) - 84usize];
    ["Offset of field: GeoIPTag::last_mtime_check"]
        [::std::mem::offset_of!(GeoIPTag, last_mtime_check) - 88usize];
    ["Offset of field: GeoIPTag::dyn_seg_size"]
        [::std::mem::offset_of!(GeoIPTag, dyn_seg_size) - 96usize];
    ["Offset of field: GeoIPTag::ext_flags"]
        [::std::mem::offset_of!(GeoIPTag, ext_flags) - 104usize];
};
...
extern "C" {
    pub fn GeoIP_open(filename: *const ::std::ffi::c_char, flags: ::std::ffi::c_int) -> *mut GeoIP;
}
extern "C" {
...
extern "C" {
    pub fn GeoIP_database_edition(gi: *mut GeoIP) -> ::std::ffi::c_uchar;
}
extern "C" {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct GeoIPRecordTag {
    pub country_code: *mut ::std::ffi::c_char,
    pub country_code3: *mut ::std::ffi::c_char,
    pub country_name: *mut ::std::ffi::c_char,
    pub region: *mut ::std::ffi::c_char,
    pub city: *mut ::std::ffi::c_char,
    pub postal_code: *mut ::std::ffi::c_char,
    pub latitude: f32,
    pub longitude: f32,
    pub __bindgen_anon_1: GeoIPRecordTag__bindgen_ty_1,
    pub area_code: ::std::ffi::c_int,
    pub charset: ::std::ffi::c_int,
    pub continent_code: *mut ::std::ffi::c_char,
    pub netmask: ::std::ffi::c_int,
}
#[repr(C)]
#[derive(Copy, Clone)]
pub union GeoIPRecordTag__bindgen_ty_1 {
    pub metro_code: ::std::ffi::c_int,
    pub dma_code: ::std::ffi::c_int,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of GeoIPRecordTag__bindgen_ty_1"]
        [::std::mem::size_of::<GeoIPRecordTag__bindgen_ty_1>() - 4usize];
    ["Alignment of GeoIPRecordTag__bindgen_ty_1"]
        [::std::mem::align_of::<GeoIPRecordTag__bindgen_ty_1>() - 4usize];
    ["Offset of field: GeoIPRecordTag__bindgen_ty_1::metro_code"]
        [::std::mem::offset_of!(GeoIPRecordTag__bindgen_ty_1, metro_code) - 0usize];
    ["Offset of field: GeoIPRecordTag__bindgen_ty_1::dma_code"]
        [::std::mem::offset_of!(GeoIPRecordTag__bindgen_ty_1, dma_code) - 0usize];
};
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of GeoIPRecordTag"][::std::mem::size_of::<GeoIPRecordTag>() - 88usize];
    ["Alignment of GeoIPRecordTag"][::std::mem::align_of::<GeoIPRecordTag>() - 8usize];
    ["Offset of field: GeoIPRecordTag::country_code"]
        [::std::mem::offset_of!(GeoIPRecordTag, country_code) - 0usize];
    ["Offset of field: GeoIPRecordTag::country_code3"]
        [::std::mem::offset_of!(GeoIPRecordTag, country_code3) - 8usize];
    ["Offset of field: GeoIPRecordTag::country_name"]
        [::std::mem::offset_of!(GeoIPRecordTag, country_name) - 16usize];
    ["Offset of field: GeoIPRecordTag::region"]
        [::std::mem::offset_of!(GeoIPRecordTag, region) - 24usize];
    ["Offset of field: GeoIPRecordTag::city"]
        [::std::mem::offset_of!(GeoIPRecordTag, city) - 32usize];
    ["Offset of field: GeoIPRecordTag::postal_code"]
        [::std::mem::offset_of!(GeoIPRecordTag, postal_code) - 40usize];
    ["Offset of field: GeoIPRecordTag::latitude"]
        [::std::mem::offset_of!(GeoIPRecordTag, latitude) - 48usize];
    ["Offset of field: GeoIPRecordTag::longitude"]
        [::std::mem::offset_of!(GeoIPRecordTag, longitude) - 52usize];
    ["Offset of field: GeoIPRecordTag::area_code"]
        [::std::mem::offset_of!(GeoIPRecordTag, area_code) - 60usize];
    ["Offset of field: GeoIPRecordTag::charset"]
        [::std::mem::offset_of!(GeoIPRecordTag, charset) - 64usize];
    ["Offset of field: GeoIPRecordTag::continent_code"]
        [::std::mem::offset_of!(GeoIPRecordTag, continent_code) - 72usize];
    ["Offset of field: GeoIPRecordTag::netmask"]
        [::std::mem::offset_of!(GeoIPRecordTag, netmask) - 80usize];
};
pub type GeoIPRecord = GeoIPRecordTag;
extern "C" {
    pub fn GeoIP_record_by_ipnum(gi: *mut GeoIP, ipnum: ::std::ffi::c_ulong) -> *mut GeoIPRecord;
}
extern "C" {
    pub fn GeoIP_record_by_addr(
        gi: *mut GeoIP,
        addr: *const ::std::ffi::c_char,
    ) -> *mut GeoIPRecord;
}
extern "C" {
    pub fn GeoIP_record_by_name(
        gi: *mut GeoIP,
        host: *const ::std::ffi::c_char,
    ) -> *mut GeoIPRecord;
}
extern "C" {
    pub fn GeoIP_record_by_ipnum_v6(gi: *mut GeoIP, ipnum: geoipv6_t) -> *mut GeoIPRecord;
}
extern "C" {
    pub fn GeoIP_record_by_addr_v6(
        gi: *mut GeoIP,
        addr: *const ::std::ffi::c_char,
    ) -> *mut GeoIPRecord;
}
extern "C" {
    pub fn GeoIP_record_by_name_v6(
        gi: *mut GeoIP,
        host: *const ::std::ffi::c_char,
    ) -> *mut GeoIPRecord;
}
extern "C" {
    pub fn GeoIP_record_id_by_addr(
        gi: *mut GeoIP,
        addr: *const ::std::ffi::c_char,
    ) -> ::std::ffi::c_int;
}
extern "C" {
    pub fn GeoIP_record_id_by_addr_v6(
        gi: *mut GeoIP,
        addr: *const ::std::ffi::c_char,
    ) -> ::std::ffi::c_int;
}
extern "C" {
    pub fn GeoIP_init_record_iter(gi: *mut GeoIP) -> ::std::ffi::c_int;
}
extern "C" {
    pub fn GeoIP_next_record(
        gi: *mut GeoIP,
        gir: *mut *mut GeoIPRecord,
        record_iter: *mut ::std::ffi::c_int,
    ) -> ::std::ffi::c_int;
}
extern "C" {
    pub fn GeoIPRecord_delete(gir: *mut GeoIPRecord);
}
